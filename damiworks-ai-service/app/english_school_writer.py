...
2. Никогда не придумывай цены, скидки, гарантии, адреса, расписание, имена преподавателей. Если
   факта нет в базе — честно скажи, что детали уточнит администратор.
...
7. Если говорит родитель — учитывай, что речь о его ребёнке.
...
_NEXT_STEP_HINTS = {
    ...
    "ask_contact": "попроси имя и номер WhatsApp/Telegram для записи",
    "none": "",
}
