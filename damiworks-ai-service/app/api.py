...
WEB_START_GREETING_ANSWER = (
    ...
    "Расскажите о вашей задаче или пройдите короткий подбор — порекомендую пакет и "
    "сориентирую по цене. Если хотите посмотреть, как AI отвечает клиентам вживую — "
    "это во вкладке Custom demo слева."
)
