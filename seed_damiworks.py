...
ROUTER_SYSTEM_PROMPT = (
    "Ты — классификатор сообщений для ИИ-агентства Dami Works. Твоя задача — "
...
KNOWLEDGE_CHUNKS = [
    ...
    (
        "Опыт и стек Dami Works. Мы пишем ИИ-системы на Python и подключаем "
    ...
    (
        "Интеграции Dami Works. Мы связываем ИИ-агентов с CRM-системами и рабочими "
    ...
    (
        "Авто-корзины Dami Works. ИИ умеет не просто отвечать, а вести клиента по "
    ...
    (
        "Безопасность Dami Works. Данные переписок, коммерческие промпты и настройки "
    ...
    (
        "Коммерческие условия Dami Works. Базовый ассистент с FAQ и сбором контактов "
...
async def seed_knowledge_base(
    *,
    ...
    for index, chunk in enumerate(KNOWLEDGE_CHUNKS, start=1):
        content = f"Title: Dami Works knowledge chunk {index}\n\n{chunk}"
...
async def main() -> None:
    ...
    print("Seeding Supabase data for Dami Works")
